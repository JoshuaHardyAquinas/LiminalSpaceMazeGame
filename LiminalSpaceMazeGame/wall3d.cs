...
namespace LiminalSpaceMazeGame
{
    public class wall3d: StationaryObject 
    {
        ...
        public wall3d(int width,int height, Vector2 location, int textureSlice, char objHit)
        {
            type = objHit;
            Height = height;
        ...
        static public wall3d generate3dWall(Vector2 displacement, int slice, Vector2 gameRes,Vector2 centreDis,char objHit)
        {
            ...
            return new wall3d(4, Convert.ToInt32(wallHieght), location,textureSlice,objHit); ;//return so it can be added to the list
        }
    }
}
